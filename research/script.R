...
febWeather = read.table('datasets/weather/2015/febWeather.csv', header = T)
marWeather = read.table('datasets/weather/2015/marWeather.csv', header = T)
aprWeather = read.table('datasets/weather/2015/aprWeather.csv', header = T)
mayWeather = read.table('datasets/weather/2015/mayWeather.csv', header = T)
junWeather = read.table('datasets/weather/2015/junWeather.csv', header = T)
julWeather = read.table('datasets/weather/2015/julWeather.csv', header = T)
augWeather = read.table('datasets/weather/2015/augWeather.csv', header = T)
sepWeather = read.table('datasets/weather/2015/sepWeather.csv', header = T)
octWeather = read.table('datasets/weather/2015/octWeather.csv', header = T)
novWeather = read.table('datasets/weather/2015/novWeather.csv', header = T)
decWeather = read.table('datasets/weather/2015/decWeather.csv', header = T)
